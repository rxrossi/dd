...
function getMonthRange(date) {
  ...
  return [new Date(getYearAndMonthStr(currentDate)), new Date(getYearAndMonthStr(nextMonth))]
}
  ...
  render() {
    ...
    return professional ? (
      <div>
        ...
        Comissão: {commission}
        <hr />
        <input type="month" onChange={this.onMonthSelect} name="month" defaultValue={getYearAndMonthStr(new Date())} />
